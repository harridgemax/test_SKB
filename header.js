...
(function () {
  ...
  function mountOverlay() {
    ...
    var allViews = [contentView, esportView, liveView];
    ...
    /* Profil / Game → show main content */
    [allNavTabs[2], allNavTabs[3]].forEach(function (item) {
      item.addEventListener('click', function () {
        deactivateAllTabs(); activateTab(item);
        hideAllViews();
        contentView.style.display = '';
      });
    });
